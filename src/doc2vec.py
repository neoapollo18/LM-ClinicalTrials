...
combined_model = CombinedModel(doc2vec_dim=doc2vec_dim, num_classes=2, dropout_rate=0.6)
combined_model = combined_model.to(device)

optimizer = AdamW(combined_model.parameters(), lr = 0.000004,)
...
for epoch_i in range(0, epochs):
    ...
    wandb.log({"avg-val-loss": avg_val_loss})
