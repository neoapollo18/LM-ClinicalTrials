...
df = pd.read_csv('ClinicalTrials/src/TrialData/trial_data1.csv')


sweep_config = {
    'name': 'EmbeddingsSweepLarge',
...
def train():
    ...
    combined_model = CombinedModel(num_extra_features=sum(embedding_dims.values()), num_classes=2, dropout_rate=dropout_rate, embedding_dims=embedding_dims)
