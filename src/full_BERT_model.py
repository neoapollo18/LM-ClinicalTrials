...
df = pd.read_csv('trial_data1.csv')
...
combined_model = CombinedModel(num_extra_features=train_onehot_encoded.shape[1], num_classes=2, dropout_rate=0.1)
combined_model = combined_model.to(device)
optimizer = AdamW(combined_model.parameters(), lr = 1e-4,)
...
# wandb.watch(combined_model, log_freq=100)
